...
function App() {
  ...
  return (
    <div className="App">
      ...
      <input type='string' placeholder='divide' value={MultiValue1} onChange={(e) => setMultiValue1(e.target.value)} />
     <button onClick={(e)=> MultiFirstValue(MultiValue1)} >*</button>
     <input type='string' placeholder='divide' value={MultiValue2} onChange={(e) => setMultiValue2(e.target.value)} />
     <button onClick={(e) => MultiSecondValue(MultiValue2)} >=</button>
      </div>

      <div className='multi' >
      <input type='string' placeholder='multiply' value={DivideValue1} onChange={(e) => setDivideValue1(e.target.value)} />
     <button onClick={(e)=> DivideFirstValue(DivideValue1)} >/</button>
     <input type='string' placeholder='multiply' value={DivideValue2} onChange={(e) => setDivideValue2(e.target.value)} />
